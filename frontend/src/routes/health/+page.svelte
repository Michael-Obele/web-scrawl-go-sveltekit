...
<div class="container mx-auto p-8">
  ...
  {#if data.health}
          ...
          >
            ...
            <div>
              ...
              <dd class="inline ml-2">
                {new Date(data.health.timestamp * 1000).toLocaleString()}
              </dd>
            </div>
          </dl>
        </div>
    ...
    <Alert.Root class="mt-6">
      ...
      <Alert.Description>
        Your web scraper backend is running and responding correctly. All
        scraping functionality should work as expected.
      </Alert.Description>
    </Alert.Root>
  {:else}
      ...
      <div class="flex items-start gap-4">
        ...
        <div>
          ...
          <p class="text-red-700 text-sm mt-2">
            The backend server may be sleeping. Click the button below to wake
            it up.
          </p>
          <button
            onclick={wakeBackend}
    ...
    <Alert.Root variant="destructive" class="mt-6">
      ...
      <Alert.Description>
        <p class="mb-2">
          The backend server is not currently running. If you're running this
          locally, start the Go backend server:
        </p>
