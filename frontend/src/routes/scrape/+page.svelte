          ...
          <Card.Root>
            ...
            <Card.Content>
              <Tabs.Tabs value="markdown">
                <Tabs.TabsList>
                  <Tabs.TabsTrigger value="markdown">Markdown</Tabs.TabsTrigger>
                  <Tabs.TabsTrigger value="html">Raw HTML</Tabs.TabsTrigger>
                  <Tabs.TabsTrigger value="links">Links</Tabs.TabsTrigger>
                </Tabs.TabsList>
                ...
                <Tabs.TabsContent value="links">
                  <div class="rounded-md border overflow-hidden mt-4">
                    <Table.Root>
                      <Table.Header>
                        <Table.Row>
                  ...
                  {#if scrapeWebsite.result.final.links.length > 50}
                    <p class="text-sm text-muted-foreground mt-3">
                      Showing first 50 of {scrapeWebsite.result.final.links
                        .length} links
                    </p>
                  {/if}
                </Tabs.TabsContent>
                ...
                <div class="border-l-4 border-yellow-400 bg-yellow-50 p-4 mt-6">
                  <div class="flex">
                    <div class="flex-shrink-0">
                      <Scale class="h-5 w-5 text-yellow-400" />
                    </div>
                    <div class="ml-3">
                      <p class="text-sm text-yellow-700">
                        Warnings detected during scraping:
                      </p>
                      <ul
